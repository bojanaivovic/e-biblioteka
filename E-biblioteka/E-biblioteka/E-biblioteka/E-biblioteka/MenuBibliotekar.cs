...
//------------------------------------------TAB DOSIJE------------------------------------------
        ...
        private void PrikaziObavestenja()
        {
            MySqlConnection con = new MySqlConnection("server = localhost; database =e_biblioteka; username = root; password =; SSL Mode = None");
            con.Open();
        //prvo provera za istekle pozajmice
            string query1 = "UPDATE pozajmica set  isteklo='Da' where datediff(now(),datum_uzimanja)>30 and vraceno='Ne'";
            MySqlCommand cmd1 = new MySqlCommand(query1, con);
            cmd1.ExecuteNonQuery();


        //stampanje isetklih pozajmica    
            string query = "SELECT pozajmica_ID, korisnicko_ime, ime, prezime, knjiga_ID, naziv_dela, datum_uzimanja from pozajmica p inner join dela on knjiga_ID=delo_ID inner join korisnik k where k.korisnik_ID=p.korisnik_ID and isteklo='Da' and seen_bibliotekar!=1 ";
         ...
         //seen za bibliotekara
            string query2 = "UPDATE pozajmica set seen_bibliotekar=1 where isteklo='Da' ";
        ...
        private void obavestenjaStudentDgv_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
